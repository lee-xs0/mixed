...
exports.rgbaToHex = exports.regRgbaFormat = exports.hexToRgba = void 0;
/*
 * @Author: atwLee
 ...
 * @return {*}
 */
var rgbaToHex = function rgbaToHex(val, alpha) {
...
var hexToRgba = function hexToRgba(val) {
  // 16进制颜色值的正则
...
var regRgbaFormat = function regRgbaFormat(val) {
  var regRgba = /rgba?\((\d{1,3}),(\d{1,3}),(\d{1,3})(,([.\d]+))?\)/;
  return regRgba.test(val);
};
exports.regRgbaFormat = regRgbaFormat;